...
const services: IService[] = [
    {
        title: 'Akupunktur',
        description: ['Traditionelle chinesische Medizin zur Harmonisierung des Energieflusses. Schmerz ist der Schrei nach fließender Energie. Akupunktur trägt damit zur und Linderung verschiedener Beschwerden bei.'],
        icon: (
